...
![Project-design](https://github.com/user-attachments/assets/2e6c2c4d-5e5c-49ca-bd24-bc673a4876c7)
...
![image](https://github.com/user-attachments/assets/eddf29b8-f10b-4506-a33a-9b575da61b15)
...
![image](https://github.com/user-attachments/assets/ae6ddcfc-7b80-46d4-9684-afdaa5577af6)
...
#### **5\. Generate SSH Keys (**`terra-ansible-multienv-key` and [`terra-ansible-multienv-key.pub`])
...
* This generates two files:
    ...
    * `terra-ansible-multienv-key` (private key)
        
    * [`terra-ansible-multienv-key.pub`] (public key)
...
![image](https://github.com/user-attachments/assets/b6ea2405-02ed-414b-b1ba-e3b9235e76ed)


b. `terraform plan` : Review the plan to apply changes

![image](https://github.com/user-attachments/assets/a4deff7e-08a1-4cdf-b185-9452b4c72a7b)


c. `terraform apply` : Apply the changes to provision infrastructur

![image](https://github.com/user-attachments/assets/27222e0e-a4ae-46d7-80f0-8f2c7cde3479)
...
1. Instances :
    ...
    !![image](https://github.com/user-attachments/assets/1189bb03-0e13-44a6-8a6f-fe5a7074b1b7)

    
2. Buckets :
    
    ![image](https://github.com/user-attachments/assets/51d4977d-c403-407c-91e1-3e1ebeae76a3)

    
3. DynamoDb tables:
    
   ![image](https://github.com/user-attachments/assets/0b3156e7-f9b8-47dd-938b-45f5b4c4a0b9)
...
![image](https://github.com/user-attachments/assets/3b3c70ba-56cd-462f-8831-566d74453678)
...
![image](https://github.com/user-attachments/assets/d85537a6-4e85-46be-a614-3419326dd92c)
